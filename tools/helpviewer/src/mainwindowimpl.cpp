...
" * when pressing CTRL+F1, the search line edit (Index tab) is not focused \n"
...
" * main tab should list the last used pages (with sane defaults for first uses) \n"
...
"   the widget is too small, hide some actions on the main toobar\n"
